"""FastAPI application for Ciicerone API.
...
from ciicerone.core.models import ThreatScenario, SimulationResult, ThreatType
...
async def get_active_simulations(sim: Simulator = Depends(get_simulator)):
